    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <input onChange={e => setDiscount(e.target.value)} value={discount} type="text" placeholder='0' min={0} max={100} className='outline-none md:py-2.5 py-2 w-28 px-3 rounded border border-gray-500' required />
        </div>
                ...
                <div>
                  {chapter.chapterContent.map((lecture, lectureIndex) =>(
                    <div key={lectureIndex}>
                      ...
                      <span>{lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDuration} mins - <a href={lecture.lectureUrl} target='_blank' className='text-blue-500'>Link</a> - {lecture.isPreviewFree ? 'Free Peview' : 'paid'}</span>
...

          {
            showPopup && (
              <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
                <div className='bg-white bg-gray-700 p-4 rounded relative w-full max-w-80'>
